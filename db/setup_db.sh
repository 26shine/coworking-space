...
echo "Seeding tokens..." && \
kubectl port-forward --namespace default svc/$1-postgresql 5432:5432 & PGPASSWORD="$POSTGRES_PASSWORD" psql --host 127.0.0.1 -U postgres -d postgres -p 5432 < 3_seed_tokens.sql && \
